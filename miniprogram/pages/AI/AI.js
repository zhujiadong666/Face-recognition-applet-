Page({
  ...
  data: {
    ...
    hair_color: "黑色",
    Expression: "超开心",
    image_src: "cloud://zhujiadong-e9urk.7a68-zhujiadong-e9urk/AI人脸识别/头像男.png",
    name: "培小华",
    hiddenmodalput: true,
  ...
  searchBox: function (e) {
    ...
    that.setData({
      ...
      major:e.detail.value.username1,
    })
  },
  // 用户点击右上角分享
          ...
          success: res => {
            ...
            wx.cloud.callFunction({
              ...
              success: res => {
                ...
                if (res.result.FaceInfos[0].FaceAttributesInfo.Expression < 10) {
                  myThis.setData({
                    Expression: "高冷"
                  });
                } else if (res.result.FaceInfos[0].FaceAttributesInfo.Expression > 10 && res.result.FaceInfos[0].FaceAttributesInfo.Expression < 50) {
                  myThis.setData({
                    Expression: "开心"
                  });
                } else {
...
//     image_src: "cloud://zhujiadong-e9urk.7a68-zhujiadong-e9urk/AI人脸识别/软件协会.jpg", //LOGO地址
...
//             })
//             myThis.setData({
//               UpdateImage: "开始你的人脸识别吧", //更改UpdateImage数据为“请点击上方按钮体验本程序”
